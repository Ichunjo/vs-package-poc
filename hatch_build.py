...
class CustomHook(BuildHookInterface[Any]):
    ...
    def initialize(self, version: str, build_data: dict[str, Any]) -> None:
        ...
        #
        # NOTE: Zig allows cross-compiling for multiple platforms at once,
        # but standard Python packaging (Wheels) expects one platform per wheel.
        ...
        # Compile the Zig project using the 'ziglang' Python package
